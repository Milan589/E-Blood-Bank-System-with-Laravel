...
class BankTypeController extends BackendBaseController
{
    protected $module = 'BankType';
    protected  $base_view = 'backend.banktype.';
    protected  $base_route = 'backend.banktype.';
    
    function __construct()
    {
        $this->model = new BankType();
    }
    /**
